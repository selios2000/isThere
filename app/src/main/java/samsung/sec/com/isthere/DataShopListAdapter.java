...
public class DataShopListAdapter extends RecyclerView.Adapter<DataShopListAdapter.ViewHolder> implements Filterable {
    private ArrayList<String> mArrayList;
    private ArrayList<String> mFilteredList;
    private Context context;
    public DataShopListAdapter(ArrayList<String> arrayList, Context appcontext) {
    ...
    @Override
    public DataShopListAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.searchlist_row, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(DataShopListAdapter.ViewHolder viewHolder, int i) {
